...
/*
|--------------------------------------------------------------------------
| Default entry (no locale) + Webhooks (NOT localized)
|--------------------------------------------------------------------------
*/
Route::redirect('/', '/en');

// Stripe Webhook endpoint (keep OUTSIDE locale)
    ...
    ->group(function () {
        ...
        */
        ...
        Route::middleware(['auth', 'verified', 'role:school'])->prefix('school')->group(function () {
            ...
            Route::get('/membership/upgrade', [MembershipController::class, 'upgrade'])
                ->name('school.memberships.upgrade');

            Route::post('/membership/purchase', [MembershipController::class, 'purchase'])
            ...
            Route::post('/membership/change-billing', [MembershipController::class, 'changeBilling'])
        ...
        */
        Route::middleware(['auth', 'role:admin|school|teacher'])
            ...
            ->group(function () {
                ...
                // ✅ JUNIOR / INTERMEDIATE static pages
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Auth routes (localized: /en/login, /fr/login, etc.)
        |--------------------------------------------------------------------------
        */
