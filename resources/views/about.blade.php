...
#infoBubble {
  ...
  .my-legend a {
    ...
    <section id="starter-section" class="py-0 bg-theme-light-yellow">
    ...
    <!-- History Section -->
    <section id="history" class="history section bg-theme-light-yellow">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6">
            ...
            <div class='my-legend'>
            <div class='legend-title'>SCB Branch Locations in Africa</div>
            <div class='legend-scale'>
            <ul class='legend-labels'>
                <li><span style='background:#008000;'></span>SCB branches in West Africa</li>
                <li><span style='background:#d35400;'></span>SCB Branches in East Africa</li>
                <li><span style='background:#ffb81c;'></span>SCB Branches in South Africa</li>
            </ul>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-lg-12">
                <h5 class="mb-3">Here are some things educators are going to need to go on this journey:</h5>
    ...
    <section class="bg-theme-light-grey">
        <div class="container">
            <div class="row mt-5">
            <div class="col-lg-8" data-aos="fade-left" data-aos-delay="200">
                <div>
                <h2><strong>Lorraine Harris</strong></h2>
                <h4><strong>Co-Founder and Co-Creator of My Place In This World</strong></h4>
                <h5><strong>Forward Thinking, Visionary, Innovator, Authentic, Risk Taker, Resilient</strong></h5>
                <p>Co-Founder and co-creator of My Place in This World, administrator Lorraine Harris has been working in the field of education for over 25 years. Lorraine is a wife and mother. She holds degrees in Education, Music, and Psychology. Lorraine has been the recipient of many awards, both locally and provincially, for her participation in various community outreach projects, sharing her gifts, time, and talents in the performing arts. Most recently she was the recipient of the Ontario Volunteer Service Award for 2020 in her region.</p>
                
                <p>Lorraine's experience working at the elementary, secondary, and university levels has equipped her with a diverse skill set. Lorraine has supported multiple schools and served diverse student populations. She has demonstrated an excellent ability to lead, support, and collaborate with teachers to ensure strategies are in place to support equity in student learning. She's a visionary with a keen ability to create engaging activities to help students grasp key curriculum content. Lorraine has created both published and unpublished resources currently being used in her board.</p>

                <p>Lorraine is an innovator with the foresight to see firsthand the need for curriculum content that empowers all students—and particularly in this current environment—Black students and others in the BIPOC community. In doing so, they develop a positive self-concept and a sense of truly belonging, of having a place in this world.</p>
                </div>
            </div>
            <div class="col-lg-4" data-aos="fade-right" data-aos-delay="100">
                <div>
                <img src="assets/img/lorraine-harris.png" class="img-fluid rounded-5" alt="Campus Visit" loading="lazy">
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="col-lg-4" data-aos="fade-right" data-aos-delay="100">
                <div>
                <img src="assets/img/michael-harris.png" class="img-fluid rounded-5" alt="Campus Visit" loading="lazy">
                </div>
            </div>
            <div class="col-lg-8" data-aos="fade-left" data-aos-delay="200">
                <div>
                <h2><strong>Michael Harris</strong></h2>
                <h4><strong>Co-Founder and Co-Creator of My Place In This World</strong></h4>
                <h5><strong>Visionary, Purpose-Driven, Strategic, Grounded in Heritage, Mentor, Cultural Architect</strong></h5>
                <p>Michael Harris is a co-founder and co-creator of My Place In This World- and the conceiver of its central concept, blueprint, direction and message. With a successful career in business and financial services, and a background in communication, Michael used his strategic expertise to ensure the curriculum would be both culturally impactful and systematically strong.</p>

                <p>The idea for My Place came about during a conversation with Lorraine Harris, who was lamenting the plight of Black youth in schools; how so many felt detached and alienated from the idea of success. Michael asked her, “What if we can build a resource that would connect the children to their heritage of success and achievement before slavery and colonization?” Lorraine, a brilliant resource writer, immediately began crafting the curriculum, bringing their vision to life.</p>

                <p>From the beginning, Michael believed that Black history must be presented as a narrative of excellence, innovation and leadership, not confined to stories of oppression. His aim was to inspire a “can do” mindset that rejects glass ceilings and connects youth to a lineage of limitless achievement. He also sought to create allyship between Black and non-Black youth rooted in mutual respect and shared learning.</p>

                <p>Under his direction, My Place In This World has grown into a resource recognized by numerous organizations- including the Government of Ontario- for its outstanding contribution to education in the province. Michael's vision continues to guide the program's mission: to strengthen character, grow self-esteem and link expectations to outcomes rooted in the glorious heritage of African and diasporic achievement.</p>
                </div>
            </div>
            </div>
        </div>
