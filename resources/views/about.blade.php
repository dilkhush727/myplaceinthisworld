      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6">
            ...
            <circle id="Sao_Tome_and_Principe"
                    cx="430" cy="660" r="6"
                    fill="#ce2129"
                    data-info="<div>Country: São Tomé and Príncipe</div><div>Capital: São Tomé</div>" />

            <!-- Comoros -->
            <circle id="Comoros"
                    cx="1015" cy="900" r="6"
                    fill="#ce2129"
                    data-info="<div>Country: Comoros</div><div>Capital: Moroni</div>" />

            <!-- Seychelles -->
            <circle id="Seychelles"
                    cx="1060" cy="760" r="6"
                    fill="#ce2129"
