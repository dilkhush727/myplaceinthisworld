...
<button
  ...
  title="{{ t('chatbot.button_title', 'Chat') }}"
>
...
<div class="offcanvas offcanvas-end chatbot-open-box" tabindex="-1" id="chatbotOffcanvas" aria-labelledby="chatbotOffcanvasLabel">
  <div class="offcanvas-header border-bottom gap-2">
    ...
    <div>
      <img src="{{ asset('assets/img/zola-chat-bot.png') }}"
           alt="{{ t('chatbot.avatar_alt', 'Zola Chatbot') }}"
           style="width:40px; height:40px;">
    </div>

    <div>
      <h5 class="offcanvas-title mb-0" id="chatbotOffcanvasLabel">
        {{ t('chatbot.title', 'Discuss with Zola') }}
      </h5>
      <small class="text-muted">
        {{ t('chatbot.subtitle', 'Ask about activities or support') }}
      </small>
    </div>
