...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    <div class="m-headerOLD text-center">
      <a href="{{ url(app()->getLocale()) }}" class="b-brand text-primary">
      ...
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="{{ route('admin.dashboard') }}" class="pc-link">
            ...
            <span class="pc-mtext">{{ t('admin.nav.dashboard', 'Dashboard') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('admin/galleries*') ? 'active' : '' }}">
            <a href="{{ route('admin.gallery.index') }}" class="pc-link">
                ...
                <span class="pc-mtext">{{ t('admin.nav.gallery', 'Gallery of Growth') }}</span>
            </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('admin/courses*') ? 'active' : '' }}">
          <a href="{{ route('admin.courses.index') }}" class="pc-link">
              ...
              <span class="pc-mtext">{{ t('admin.nav.divisions', 'Divisions of Learning') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('admin/learning-progress*') ? 'active' : '' }}">
          <a href="{{ route('admin.learning-progress.index') }}" class="pc-link">
            ...
            <span class="pc-mtext">{{ t('admin.nav.learning_progress', 'Learning Progress') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('admin/users*') ? 'active' : '' }}">
          <a href="{{ route('admin.users.index') }}" class="pc-link">
            ...
            <span class="pc-mtext">{{ t('admin.nav.manage_users', 'Manage Users') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item">
          <a href="{{ route('admin.memberships.index') }}" class="pc-link">
            ...
            <span class="pc-mtext">{{ t('admin.nav.memberships', 'Memberships') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item pc-hasmenu">
          <a href="javascript:;" class="pc-link">
            ...
            <span class="pc-mtext">{{ t('admin.nav.contacts', 'Contacts') }}</span>
          ...
          <ul class="pc-submenu">
            <li class="pc-item">
              <a href="{{ route('admin.contacts.index') }}" class="pc-link">
                <span class="pc-mtext">{{ t('admin.nav.contact_us', 'Contact Us') }}</span>
              </a>
            </li>
            <li class="pc-item">
              <a href="{{ route('admin.tickets.index') }}" class="pc-link">
                <span class="pc-mtext">{{ t('admin.nav.tickets', 'Tickets') }}</span>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="pc-item">
          <a href="{{ route('school.dashboard') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-dashboard"></i></span>
            <span class="pc-mtext">{{ t('school.nav.dashboard', 'Dashboard') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('school/galleries*') ? 'active' : '' }}">
            <a href="{{ route('school.gallery.index') }}" class="pc-link">
                <span class="pc-micon"><i class="ti ti-photo"></i></span>
                <span class="pc-mtext">{{ t('school.nav.gallery', 'Gallery of Growth') }}</span>
            </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('divisions*') ? 'active' : '' }}">
          <a href="{{ route('divisions.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-book"></i></span>
            <span class="pc-mtext">{{ t('school.nav.divisions', 'Divisions of Learning') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('school/learning-progress*') ? 'active' : '' }}">
          <a href="{{ route('school.learning-progress.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-chart-bar"></i></span>
            <span class="pc-mtext">{{ t('school.nav.learning_progress', 'Learning Progress') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('school/teachers*') ? 'active' : '' }}">
          <a href="{{ route('school.teachers.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-users"></i></span>
            <span class="pc-mtext">{{ t('school.nav.teachers', 'Teachers') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item pc-hasmenu">
          <a href="javascript:;" class="pc-link">
            <span class="pc-micon"><i class="ti ti-settings"></i></span>
            <span class="pc-mtext">{{ t('school.nav.membership', 'Membership') }}</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
          </a>
          <ul class="pc-submenu">
            <li class="pc-item"><a href="{{ route('school.memberships.manage') }}" class="pc-link">{{ t('school.nav.manage', 'Manage') }}</a></li>
            <li class="pc-item"><a href="{{ route('school.memberships.upgrade') }}" class="pc-link">{{ t('school.nav.upgrade', 'Upgrade') }}</a></li>
          </ul>
        </li>
        ...
        <li class="pc-item {{ request()->routeIs('school.tickets.*') ? 'active' : '' }}">
          <a href="{{ route('school.tickets.index') }}" class="pc-link">
            ...
            <span class="pc-mtext">{{ t('school.nav.support_tickets', 'Support Tickets') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item">
          <a href="{{ route('teacher.dashboard') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-dashboard"></i></span>
            <span class="pc-mtext">{{ t('teacher.nav.dashboard', 'Dashboard') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('teacher/galleries*') ? 'active' : '' }}">
            <a href="{{ route('teacher.gallery.index') }}" class="pc-link">
                <span class="pc-micon"><i class="ti ti-photo"></i></span>
                <span class="pc-mtext">{{ t('teacher.nav.gallery', 'Gallery of Growth') }}</span>
            </a>
        </li>
        ...
        <li class="pc-item {{ request()->is('divisions*') ? 'active' : '' }}">
          <a href="{{ route('divisions.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-book"></i></span>
            <span class="pc-mtext">{{ t('teacher.nav.divisions', 'Divisions of Learning') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item">
          <a href="{{ route('teacher.learning-progress.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-book"></i></span>
            <span class="pc-mtext">{{ t('teacher.nav.my_learning', 'My Learning') }}</span>
          </a>
        </li>
        ...
        <li class="pc-item">
          <a href="{{ route('teacher.tickets.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-mail"></i></span>
            <span class="pc-mtext">{{ t('teacher.nav.tickets', 'Tickets') }}</span>
          </a>
        </li>
        @endif
        ...
        <li class="pc-item">
          <a href="javascript:;" class="pc-link"
            onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              ...
              <span class="pc-mtext">{{ t('common.logout', 'Logout') }}</span>
          </a>
