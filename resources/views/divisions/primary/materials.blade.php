...
<div class="container py-4">
  ...
  <div class="d-flex justify-content-between gap-3 mb-4 flex-wrap">
    <div>
        <a href="{{ route('divisions.primary.materials') }}" class="btn btn-dark rounded-pill px-4">Materials</a>
        <a href="{{ route('divisions.primary.biographies') }}" class="btn btn-outline-dark rounded-pill px-4">Biographies</a>
  ...
  <div class="row g-4">
    ...
    <div class="col-lg-4">
      ...
      <div class="card border-0 shadow-sm rounded-4 p-4 mt-4">
        <h6 class="fw-semibold mb-2">Also in High School</h6>
        <div class="d-grid gap-2">
          <a href="{{ route('divisions.highschool.biographies') }}" class="btn btn-outline-dark rounded-pill">
            Biographies
          </a>
          <a href="{{ route('divisions.highschool.glossary') }}" class="btn btn-outline-dark rounded-pill">
            Glossary of Terms
          </a>
        </div>
      </div>
